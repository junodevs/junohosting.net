<template>
  <main>
    ...
    <p>
      We take our customer's privacy very seriously. Information such as address,
      phone, etc. will not be given out. However, we reserve the right to monitor
      your account. We will also use the given information to verify you as the
      account holder in the event you forgot your password.
    </p>
